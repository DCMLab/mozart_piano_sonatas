...
* `The Annotated Mozart Sonatas: Score, Harmony, and Cadence <https://github.com/DCMLab/mozart_piano_sonatas/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first movement of the first sonata, K. 279 has the following files:
